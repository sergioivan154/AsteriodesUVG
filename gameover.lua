...
local overlay = display.newImageRect ("images/overlayv2.png", 400 , 250)
			overlay.x = centerX
			overlay.y = centerY
...
local nextlevelBtn = display.newImageRect ("images/playBtn.png" ,112, 116)
